...
public class DataListOpenbravoTool extends DefaultApplicationPlugin {
    ...
    public String getPropertyOptions() {
        return AppUtil.readPluginResource(getClassName(), "/properties/process/DataListOpenbravoTool.json", null, true, "/messages/Openbravo");
    }
